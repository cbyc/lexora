...
from lexora.knowledge.loaders.bookmarks import (
    BookmarkRecord,
    _query_bookmarks,
    fetch_documents,
    fetch_page_content,
...
class TestFetchPageContent:
    ...
    @patch("lexora.knowledge.loaders.bookmarks.trafilatura.fetch_url")
    @patch("lexora.knowledge.loaders.bookmarks.trafilatura.extract")
...
class TestResolveProfilePath:
    ...
    def test_none_triggers_auto_detect(self, tmp_path: Path):
        ...
        with patch(
            "lexora.knowledge.loaders.bookmarks.find_firefox_profile",
    ...
    def test_returns_none_when_no_profile_found(self):
        ...
        with patch(
            "lexora.knowledge.loaders.bookmarks.find_firefox_profile", return_value=None
        ):
            result = resolve_profile_path(None)
        assert result is None
...
class TestFetchDocuments:
    ...
    @patch("lexora.knowledge.loaders.bookmarks.fetch_page_content")
