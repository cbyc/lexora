...
from knowledge.loaders.bookmarks import (
    BookmarkRecord,
    _query_bookmarks,
    fetch_documents,
    fetch_page_content,
...
class TestFetchPageContent:
    ...
    @patch("knowledge.loaders.bookmarks.trafilatura.fetch_url")
    @patch("knowledge.loaders.bookmarks.trafilatura.extract")
...
class TestResolveProfilePath:
    ...
    def test_none_triggers_auto_detect(self, tmp_path: Path):
        ...
        with patch(
            "knowledge.loaders.bookmarks.find_firefox_profile",
    ...
    def test_returns_none_when_no_profile_found(self):
        ...
        with patch(
            "knowledge.loaders.bookmarks.find_firefox_profile", return_value=None
        ):
            result = resolve_profile_path(None)
        assert result is None
...
class TestFetchDocuments:
    ...
    @patch("knowledge.loaders.bookmarks.fetch_page_content")
